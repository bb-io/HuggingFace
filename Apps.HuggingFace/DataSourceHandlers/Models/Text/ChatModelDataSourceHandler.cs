...
public class ChatModelDataSourceHandler : BaseInvocable, IAsyncDataSourceHandler
{
    public ChatModelDataSourceHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint = $"/models?search={context.SearchString ?? ""}&sort=likes&direction=-1&filter=conversational&limit=30";
        ...
        return models.Where(model => model.PipelineTag == "conversational")
