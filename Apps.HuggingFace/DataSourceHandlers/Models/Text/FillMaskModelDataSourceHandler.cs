...
public class FillMaskModelDataSourceHandler : BaseInvocable, IAsyncDataSourceHandler
{
    public FillMaskModelDataSourceHandler(InvocationContext invocationContext) : base(invocationContext)
    {
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        var endpoint = $"/models?search={context.SearchString ?? ""}&sort=likes&direction=-1&filter=fill-mask&limit=30";
        ...
        return models.Where(model => model.PipelineTag == "fill-mask")
